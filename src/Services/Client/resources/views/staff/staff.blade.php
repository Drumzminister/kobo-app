                                      ...
                                      <td class="flex" >
                                          <div class="dropdown">
                                              ...
                                              <div class="dropdown-menu dropdown-menu-right p-0"  style="max-width:30px; font-size: 16px" aria-labelledby="dropdownMenuButton1">
                                                  ...
                                                  <a v-if="worker.isActive"@click.prevent="deactivateStaff(worker)" class="dropdown-item text-danger" href="#"><i class="fa fa-eye"></i><i class="fa fa-lock-open"> Activate</i></a>
                                                  <a v-else="! worker.isActive"@click.prevent="deactivateStaff(worker)" class="dropdown-item text-danger" href="#"> <i class="fa fa-trash"> Deactivate</i></a>
