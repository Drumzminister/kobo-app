            ...
            <div class="bg-white p-5">
                ...
                <div class="form-group row py-2">
                    ...
                    <div class="col-md-8">
                        ...
                        <input v-model="customerForm.phone" name="phone" type="text" v-validate="'required|min:11'" class="form-control bg-grey" value="ekpno" >
                        <div v-if="customerFormSubmitted && errors.has('phone')" class="text-danger">@{{ errors.first('phone') }}</div><br>

                        <label for="phone">Email</label>
                        <input v-model="customerForm.email" v-validate="'email'" name="email" value="{{$data['email']}}" type="text" class="form-control bg-grey" id="" >
...
{{$data}}
                ...
                <div class="form-row mt-3">
                    ...
                    <div class="col-md-8">
                        ...
                        <button type="submit" class="btn btn-addsale" @click="createCustomer"  data-dismiss="modal" type="submit">Update Information</button>
                    </div>
                </div>
            </div>
        </div>
